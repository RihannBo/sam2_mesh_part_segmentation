...
from seg3d.ablation_studies.models.sam2_base_dual_orig_mem import SAM2DualOrigMem
...
class SAM2DualOrigMemPredictor(SAM2DualOrigMem):
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        Returns:
            A `SAM2DualOrigMemPredictor` instance backed by the finetuned `SAM2DualOrigMem`.
        """
        ...
        predictor: SAM2DualOrigMemPredictor = model  # type: ignore[assignment]
        ...
        if kwargs:
            warnings.warn(
                    f"SAM2DualOrigMemPredictor.from_pretrained: unused kwargs {list(kwargs.keys())}",
                stacklevel=2,
            )
